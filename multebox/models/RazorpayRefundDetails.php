...
/**
 * This is the model class for table "tbl_razorpay_refund_details".
 *
 * @property int $id
 ...
 */
class RazorpayRefundDetails extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_razorpay_refund_details';
    }
