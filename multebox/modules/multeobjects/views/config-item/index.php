 ...
 * @var multebox\models\search\ConfigItem $searchModel
 */
...
//            'updated_at',
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['/multeobjects/config-item/view','id' => $model->id,'edit'=>'t']), [
