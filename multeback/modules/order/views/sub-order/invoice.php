...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'View Order'), 'url' => ['sub-order-view', 'id' => $sub_order->id]];
$this->params['breadcrumbs'][] = Yii::t('app', 'Invoice');
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> <?=Yii::$app->params['COMPANY_NAME']?>
            <small class="pull-right"><?=Yii::t('app', 'Date')?>: <?=$invoice->added_at?date('d-M-Y H:i', $invoice->added_at):date('d-M-Y H:i')?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tr>
			  ...
			  ?>
              <td><?=MulteModel::formatAmount($before_tax*$sub_order->conversion_rate, $sub_order->order_currency_symbol)?> x <?=$sub_order->total_items?></td>
            </tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
			...
			echo Html::a('<i class="fa fa-download"></i> '.Yii::t('app','Download Invoice'), 
						Url::to(['/order/sub-order/get-invoice-pdf', 'id' => $sub_order->id]), 
									[
										'class' => 'btn btn-primary btn-sm',
									]);
								?>
