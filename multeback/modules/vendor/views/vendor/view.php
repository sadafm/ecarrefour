...
use multebox\models\search\Vendor;
...
$this->title = Yii::t('app', 'Update Vendor').' : ' . $model->vendor_name;
...
function ajaxFileUpload(upload_field)
{
	...
	upload_field.form.action = "<?=Url::to(['/vendor/vendor/view', 'id' => $_GET['id']])?>";
...
if('<?= isset($msgBox)?$msgBox:''?>' != ''){
		setTimeout(function(){
			document.location.href="<?=Url::to(['/vendor/vendor/view', 'id' => $_GET['id']])?>";
		},2000);
	}
...
<div class="panel panel-info">
	<div class="panel-heading">
    	<h3 class="panel-title"><?php echo Yii::t('app', 'Vendor'); ?> - <?=$model->vendor_name?>
        	<div class="pull-right">
                <a class="close" href="<?=Url::to(['/vendor/vendor/index'])?>" >
    ...
    <div class="panel-body">
        	<div class="vendor-update">
        		<div class="row">
                     ...
                     <?=  Form::widget ( [ 
							...
							'attributes' => [ 
									'vendor_type_id' => [ 
                                            ...
                                            'items' => ArrayHelper::map ( VendorType::find ()->orderBy ( 'sort_order' )->asArray ()->all (), 'id', 'label' )
                                    ]
                                ] 
                        ]
                     );?>
                    ...
                    <div class="col-sm-3" style="overflow:hidden" align="center">
                    	...
                    	<?php
							if(MulteModel::fileExists(Yii::$app->params['web_url'].'/vendors/'.$model->id.'.png')){?>
                            	<img src="<?=Yii::$app->params['web_url']?>/vendors/<?=$model->id?>.png" style="height:185px;" class="upload img-responsive">								
							<?php }else{?>
								<img src="<?=Url::base()?>/nophoto.jpg" style="height:185px;" class="upload img-responsive">
							<?php }
						?>
                        <input type="file" name="vendor_image" class="form-control inp">
                    </div>
                </div>
                ...
                <ul class="nav nav-tabs">
					...
					<li>
						<a href="#attachment" role="tab" data-toggle="tab"><?php echo Yii::t('app', 'Attachments'); ?>
							<span class="badge"> <?= FileModel::getAttachmentCount('vendor',$model->id)?></span>
						</a>
					</li>
            ...
            <div class="tab-content">
                ...
                <br/>	
				 <?php
					...
					$dataProviderNotes = $searchModelNotes->searchNotes( Yii::$app->request->getQueryParams (), $model->id,'vendor' );
			  ...
			  <?php
					...
					$dataProviderAttach = $searchModelAttch->searchAttachments( Yii::$app->request->getQueryParams (), $model->id,'vendor');
				...
				<?php
				   ...
				   $searchModelHistory = new MulteModel();
						$dataProviderHistory = $searchModelHistory->searchHistory( Yii::$app->request->getQueryParams (), $model->id,'vendor' );
				...
				<?php
					...
					$dataProviderAddresses = $searchAddresses->searchAddresses( Yii::$app->request->getQueryParams (), $model->id,'vendor');
				...
				<?php
					...
					$dataProviderContacts = $searchContacts->searchContacts( Yii::$app->request->getQueryParams (), $model->id,'vendor');
           ...
           <?php
            echo Html::submitButton ( $model->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Update'), [ 
                                    ...
                                    'class' => $model->isNewRecord ? 'btn btn-success vendor_submit' : 'btn btn-primary btn-sm  vendor_submit' 
