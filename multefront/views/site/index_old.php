...
<div class="main-container col1-layout">
                ...
                <div class="product-item">
                  <div class="item-inner">
                    <div class="product-thumbnail">
                      ...
                      <div class="pr-img-area"> <a title="<?=$inventoryItem->product_name?>" href="<?=$url?>">
                        <figure> <img class="first-img" src="<?=Yii::$app->params['web_url']?>/<?=$fileDetails->new_file_name?>" alt="<?=$inventoryItem->product_name?>"> <img class="hover-img" src="<?=Yii::$app->params['web_url']?>/<?=$fileDetails->new_file_name?>" alt="<?=$inventoryItem->product_name?>"></figure>
                        </a>
                        <?php
						if(intval(Yii::$app->params['HOT_DEAL_END_DATE']) - time() > 0)
						{
	...
	?>
      <div class="col-sm-4 col-xs-12">
        <div class="jtv-banner-box banner-inner">
          <div class="image"> <a class="jtv-banner-opacity" href="<?=$url?>"><img src="<?=Yii::$app->params['web_url']?>/banner/<?=$banner->banner_new_name?>" alt="<?=$banner->banner_new_name?>"></a> </div>
      ...
      <div class="col-sm-5 col-xs-12">
        <div class="jtv-banner-box">
          <div class="image"> <a class="jtv-banner-opacity" href="javascript:void(0)"><img src="<?=Yii::$app->params['web_url']?>/banner/<?=$banner->banner_new_name?>" alt="<?=$banner->banner_new_name?>"></a> </div>
          <div class="jtv-content-text">
            <h3 class="title"><?=$banner->text_1?></h3>
            ...
            <div id="testimonials-slider" class="product-flexslider hidden-buttons home-testimonials">
              <div class="slider-items slider-width-col4 ">
				...
				<div class="holder">
                  ...
                  <div class="thumb"> <img src="<?=Yii::$app->params['web_url']?>/testimonial/<?=$testimonial->writer_new_image?>" alt="<?=$testimonial->writer_image?>"> </div>
              ...
              <div class="slider-items slider-width-col6"> 
				...
				if ($brands)
				{
					for ($i = 0; $i < count($brands); $i++)
					{
						...
						{
						?>
							<a href="javascript:void(0)"><img class="brand-img" src="<?=Yii::$app->params['web_url']?>/brand/<?=$brands[$i]['brand_new_image']?>" alt="<?=$brands[$i]['name']?>"></a>
						...
						{
						?>
							<br><a href="javascript:void(0)"><img class="brand-img" src="<?=Yii::$app->params['web_url']?>/brand/<?=$brands[$i+1]['brand_new_image']?>" alt="<?=$brands[$i+1]['name']?>"></a>
						<?php
						}
						?>
						<?php
						...
						{
						?>
						<br><a href="javascript:void(0)"><img class="brand-img" src="<?=Yii::$app->params['web_url']?>/brand/<?=$brands[$i+2]['brand_new_image']?>" alt="<?=$brands[$i+2]['name']?>"></a>
						<?php
						}
						?>
  ...
  <div class="bottom-banner-section">
    <div class="container">
	  ...
	  $url = getUrl($banner);
	  ?>
        <div class="col-md-4 col-sm-4"> <a href="<?=$url?>" class="bottom-banner-img"><img src="<?=Yii::$app->params['web_url']?>/banner/<?=$banner->banner_new_name?>" alt="<?=$banner->banner_new_name?>"> <span class="banner-overly"></span>
	  ...
	  $url = getUrl($banner);
	  ?>
        <div class="col-md-8 col-sm-8"> <a href="<?=$url?>" class="bottom-banner-img last"><img src="<?=Yii::$app->params['web_url']?>/banner/<?=$banner->banner_new_name?>" alt="<?=$banner->banner_new_name?>"> <span class="banner-overly last"></span>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6">
          <div class="jtv-single-cat">
            ...
            <div class="jtv-product jtv-cat-margin">
              <div class="product-img"> <a href="<?=$url?>"> <img img class="primary-img" src="<?=Yii::$app->params['web_url']?>/<?=$fileDetails->new_file_name?>" alt="<?=$inventoryItem->product_name?>"> <img class="secondary-img" src="<?=Yii::$app->params['web_url']?>/<?=$fileDetails->new_file_name?>" alt="<?=$inventoryItem->product_name?>"> </a> </div>
        ...
        <div class="col-md-4 col-sm-6">
          <div class="jtv-single-cat">
            ...
            <!-- Start -->
            <div class="jtv-product jtv-cat-margin">
              <div class="product-img"> <a href="<?=$url?>"> <img class="primary-img" src="<?=Yii::$app->params['web_url']?>/<?=$fileDetails->new_file_name?>" alt="<?=$inventoryItem->product_name?>"> <img class="secondary-img" src="<?=Yii::$app->params['web_url']?>/<?=$fileDetails->new_file_name?>" alt="<?=$inventoryItem->product_name?>"> </a> </div>
              <div class="jtv-product-content">
                <h3><a href="<?=$url?>"><?=$inventoryItem->product_name?></a></h3>
                <div class="price-box">
				  <?php
