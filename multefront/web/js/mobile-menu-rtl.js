    ...
    s.fn.mobileMenu = function(e) {
        ...
        return this.each(function() {
            ...
            n(), s(".mm-toggle").click(function() {
                ...
                }), s(this).hasClass("") ? s(this).removeClass("").addClass("") : s(this).removeClass("").addClass(""), s(this).toggleClass("open"), f || (l(2), f = !0)
            }), s("." + g + " > li > ul > li > span.expand").click(function() {
                if (1 == d.CollapseMenu) {
                    var e = s("." + g + " li ul li span");
                    e.hasClass("open") && "none" === s(this).next().next().css("display") && (s("." + g + " li ul ul").slideUp(), e.hasClass("open") ? e.removeClass("").addClass("") : e.removeClass("").addClass(""), e.removeClass("open"))
                }
                s(this).nextAll("." + g + " ul ul").slideToggle(function() {
                    1 == d.CollapseMenu ? s(this).promise().done(function() {
                        c.css("height", a())
                    }) : c.css("height", a())
                }), s(this).hasClass("") ? s(this).removeClass("").addClass("") : s(this).removeClass("").addClass(""), s(this).toggleClass("open")
            }), s("." + g + " li a").click(function() {
                s("." + g + " li a").removeClass("active"), s(this).addClass("active"), o()
            }), h.click(function() {
                o()
            }), s("." + g + " li a.active").parent().children(".expand").removeClass("").addClass(" open"), s("." + g + " li a.active").parent().children("ul").css("display", "block")
        })
    }
}(jQuery);